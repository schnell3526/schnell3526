...
機械学習系システムの設計や運用、機械学習実験基盤の構築、またサービスの数を効率的にスケールさせるための仕組みや文化の醸成に取り組んでいます。
...
プロダクトサイドの需要もあり、LLMOps ツールである Langfuse(V3) を EKS + マネージドサービスを利用して構築
...
現在は Platform チームに所属し、ML システムをホスティングする 50~150 ノード程度にオートスケールする EKS クラスタの管理運用をしています。
